...
| | 👨‍💻 엔지니어 | 👔 매니저 |
|---|---|---|
| **상황 설명** | "지난주 갑자기 PIP를 받았다. 1:1은 늘 괜찮아 보였는데. 뭘 놓친 건지, 앞으로 매니저 말을 믿을 수 있는 건지 모르겠다." | "지난주 1:1에서 엔지니어에게 커뮤니케이션 관련 피드백을 했다. 그 이후로 꼭 필요한 미팅 외에는 거의 말을 안 한다. 내가 잘못 처리한 건지 모르겠다." |
| **Claude — Reality 단계** | "최근 3~4번의 1:1을 돌아볼 때, 매니저가 주저하거나 주제를 바꾸거나 생각보다 부드럽게 피드백한 순간이 있었나?" | "정확히 어떻게 말했나? 실제 표현에 가깝게 적어봐라." |
| **Claude — Perspective 단계** | "매니저가 그 이전에 말하지 못하게 만든 조직적·HR적 제약이 있었다면 무엇일까? *(foundations/12 참고)*" | "엔지니어가 피드백 이후 조용해졌다. 지금 무엇을 느끼고, 무엇을 두려워하고 있을까?" |
